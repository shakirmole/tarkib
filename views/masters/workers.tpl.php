...
<div>
	<span class="place-right"> <a class="button" href="#" onclick="openWindow('?module=masters&action=worker_add')"> Add </a> </span>
	...
	<?php foreach($workers as $id=>$R) { ?>
		<tr>
			<td nowrap style="width:80px">
				<a href="#" onclick="openWindow('?module=masters&action=worker_edit&id=<?=$R['id']?>')"><span class="mif-pencil"></a>
			</td>
