...
<div>
	<span class="place-right"> <a class="button" href="#" onclick="openWindow('?module=masters&action=location_add')"> Add </a> </span>
...
<div>
	<table class="table table-border cell-border row-hover" border="0" data-role="dataTable">
		...
		<tbody>
	<?php foreach($locations as $id=>$R) { ?>
		<tr>
			<td nowrap style="width:80px">
				<a href="#" onclick="openWindow('?module=masters&action=location_edit&id=<?=$R['id']?>')"><span class="mif-pencil"></a>
			</td>
